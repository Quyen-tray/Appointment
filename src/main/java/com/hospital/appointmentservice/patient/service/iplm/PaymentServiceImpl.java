...
import com.hospital.appointmentservice.patient.repository.PaymentRepository;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    @Override
    public Payment addNewPayment(UUID invoiceId) {
        Payment newPayment = new Payment();
        Invoice invoice = invoiceRepository.findById(invoiceId).get();
        newPayment.setPaymentMethod(Payment.PaymentMethod.CASH);
        newPayment.setInvoice(invoice);
        newPayment.setPaidAt(LocalDateTime.now());
        newPayment.setPaidAmount(invoice.getAmount());
        return paymentRepository.save(newPayment);

    }

    @Override
    public PaymentResponse createNewVnPayPayment(BigDecimal price, UUID billId) throws UnsupportedEncodingException {
    ...
    public void updatePayment(UUID paymentId) {
        ...
        Invoice invoice = invoiceRepository.findById(payment.getInvoice().getId()).get();
